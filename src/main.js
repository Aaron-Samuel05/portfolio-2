...
class PortfolioApp {
  ...
  /* The opening behaves like a title sequence: the illuminated PC gets the stage first. */
  initHeroSequence() {
    ...
    // Let the PC complete its entrance before typography starts moving into frame.
    const delay = window.matchMedia('(prefers-reduced-motion: reduce)').matches ? 100 : 2950;
